...
public class Workspace {
    ...
    @Column(length = 7)
    private String couleur = "#667eea";

    @Column(name = "is_public")
    private Boolean isPublic = false;

    @ElementCollection
    @CollectionTable(name = "workspace_collaborateurs", joinColumns = @JoinColumn(name = "workspace_id"))
    ...
    @JsonIgnore
    private Set<Workspace> children;
    ...
    public Set<Workspace> getChildren() { return children; }
    public void setChildren(Set<Workspace> children) { this.children = children; }
